...
export const postStudentProfile = async (data: any) => {
  try {
    ...
    console.log("📤 Sending student profile data:", data);
...
export const getAllClasses = async () => {
  try {
    ...
    console.log("🔍 Fetching classes from:", `${API_URL}/class`);
    ...
    // Ensure we return the full data from the API response
    console.log("✅ Classes Data:", response.data);
    
    // Return the data array if available, otherwise return the whole response
